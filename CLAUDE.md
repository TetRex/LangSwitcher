...
This project has both an Xcode project (`LangSwitcher.xcodeproj`) and a Swift Package (`Package.swift`). Use whichever suits the task; Xcode is preferred for signing/distribution.
